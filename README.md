...
This semi fork from mdipierro/gluino is a succesfull attempt to upgraded the Gluino libraries to Web2py 2.14.6 (Gluino later became known as Web2y) for use with the [Pyramid](http://docs.pylonsproject.org/en/latest/) Web Framework.
